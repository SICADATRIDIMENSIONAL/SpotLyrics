...
- [ ] Interface em inglês para alcançar mais usuários ao redor do mundo.
- [ ] Versão para **Linux** – o mesmo popup de letras do Spotify para quem vive no ambiente open source.
...
- [ ] English interface to reach more users worldwide.
- [ ] **Linux version** – bringing the same Spotify lyrics popup to the open source environment.
